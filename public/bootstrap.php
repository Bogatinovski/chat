			...
			<div id="middle" class="row-fluid">
				<div id="left" class="col-sm-8 col-md-9">
					<div class="panel panel-default">
						...
						<div id="localUser" class="hidden">
							<div class="wrapper">
								<video id="localVideo" class="fullsize" autoplay muted></video>
						...
						<div id="chatWindowsContainer" class="row">
							<div class="chatColumn free col-xs-6 col-md-4 col-lg-3"></div>
							<div class="chatColumn free col-xs-6 col-md-4 col-lg-3"></div>
							<div class="chatColumn free col-xs-6 col-md-4 col-lg-3 visible-md visible-lg"></div>
							<div class="chatColumn free col-xs-6 col-md-4 col-lg-3 visible-lg"></div>
						</div>
					</div>
				</div>
